...
export default function Home() {
    // generam endppointurile pt categoriile de stiri
    ...
    const scienceData = useFetch(scienceCategoryEndpoint);
    const environmentData = useFetch(environmentCategoryEndpoint);
